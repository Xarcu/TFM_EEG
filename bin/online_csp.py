...
def process_and_classify(data_source, csp, classifier, feedback_duration=1.0, mode="online", sfreq=250, labels=None):
    ...
    while not stop_event.is_set():
        ...
        # Compute CSP features and classify
        try:
            ...
            # Increment LEFT or RIGHT counters only on valid prediction
    ...
    if total_predictions > 0:
        ...
        print(f"Total LEFT predictions: {left_predictions}, Total RIGHT predictions: {right_predictions}")
    else:
        print("No predictions compared with labels.")
        ...
        if labels_file:
            try:
                with open(labels_file, 'r') as file:
                    ...
                    if len(labels) == 0:
                        raise ValueError("Labels file contains no labels.")
